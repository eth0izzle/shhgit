...
You have two options. I'd recommend the first as it will give you access to the [shhgit web interface](https://shhgit.darkport.co.uk/).
...
2. `go get github.com/eth0izzle/shhgit` will download and build shhgit automatically. Or you can clone this repository and run `GO111MODULE=on CGO_ENABLED=0 go build -v -i -o shhgit`.
...
shhgit comes with 130 signatures. You can remove or add more by editing the `config.yaml` file.
